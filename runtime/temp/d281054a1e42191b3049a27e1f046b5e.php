...
<div class="am-g am-g-fixed blog-fixed search">
    <div class="am-u-md-12 am-u-sm-12">
		<div class="weizhi">　<a><?php echo $keywords; ?></a>　搜索结果： <a style="float:right;" href="home">返回首页>>　</a></div>
		<?php if($search != null): if(is_array($search) || $search instanceof \think\Collection || $search instanceof \think\Paginator): $i = 0; $__LIST__ = $search;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?>
	        <article class="am-g blog-entry-article" id='my-art'>
	            ...
	            <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img art-div1">
	                ...
	                <p id='p-bottom'>
	                	...
	                	<a href="article?aid=<?php echo $ca['articleId']; ?>" class="read-art">阅读原文>></a>
	                </p>
	            </div>
