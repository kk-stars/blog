<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:63:"D:\B\AppServ\www\blog/application/admin\view\notice\notice.html";i:1524019715;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\header.html";i:1524129480;s:62:"D:\B\AppServ\www\blog/application/admin\view\Public\aside.html";i:1524014121;s:61:"D:\B\AppServ\www\blog/application/admin\view\Public\info.html";i:1521016881;s:68:"D:\B\AppServ\www\blog/application/admin\view\Public\loginRecord.html";i:1524130899;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\wechat.html";i:1524130402;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\prompt.html";i:1517304229;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo url('add/addNotice'); ?>">增加公告</a></li>
          <li><a href="<?php echo url('notice/noticeRecovery'); ?>">公告回收站</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <?php if(is_array($notice) || $notice instanceof \think\Collection || $notice instanceof \think\Paginator): $i = 0; $__LIST__ = $notice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?>
              <tr id="nid_<?php echo $n['noticeId']; ?>">
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="<?php echo $n['noticeId']; ?>" /><?php echo $n['noticeId']; ?></td>
                <td class="article-title"><?php echo $n['noticeTitle']; ?></td>
                <td><?php echo $n['addTime']; ?></td>
                <td><a href="<?php echo url('update/updateNotice',array('noticeId' => $n['noticeId'])); ?>">
	                	<i class="fa fa-edit"></i> 修改　</a>
                	<a rel="6" href="javascript:;" onclick="delnotice(<?php echo $n['noticeId']; ?>)">
	                	<i class="fa fa-trash-o"></i> 删除　</a></td>
              </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
              <tr  height="80px"><td colspan='4'><div class="pagelist"><?php echo $notice->render(); ?></div></td></tr>
            </tbody>
          </table>
        </div>
...
function delnotice(noticeId){
	$.post('__URL__/noticeDel',{'noticeId':noticeId},function(info){
