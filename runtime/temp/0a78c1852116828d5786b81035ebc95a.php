<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:65:"D:\B\AppServ\www\blog/application/admin\view\message\message.html";i:1524019717;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\header.html";i:1524129480;s:62:"D:\B\AppServ\www\blog/application/admin\view\Public\aside.html";i:1524014121;s:61:"D:\B\AppServ\www\blog/application/admin\view\Public\info.html";i:1521016881;s:68:"D:\B\AppServ\www\blog/application/admin\view\Public\loginRecord.html";i:1524130899;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\wechat.html";i:1524130402;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\prompt.html";i:1517304229;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="" method="post">
        <h1 class="page-header">管理 <span class="badge"><?php echo $mCount; ?></span></h1>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th width="400px"><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">留言人</span></th>
            ...
            <tbody>
             <?php if(is_array($message) || $message instanceof \think\Collection || $message instanceof \think\Paginator): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
              <tr id="mid_<?php echo $m['messageId']; ?>">
                <td><input type="checkbox" class="input-control" id="commentid" name="checkbox[]" value="<?php echo $m['messageId']; ?>" /><?php echo $m['messageId']; ?>
                </td>
                <td class="article-title">
                	<?php echo mb_strlen( $m['messageContent'] , 'utf-8' ) > 40 ? mb_substr( $m['messageContent'] , 0 , 40 , 'utf-8' ) . '...' : $m['messageContent']; ?>
                </td>
                <td class="article-title"><?php echo $m['userName']; ?></td>
                <td><?php echo $m['addTime']; ?></td>
                <td><a id="seeComment" href="javascript:;" onClick="seeComment(<?php echo $m['messageId']; ?>)">
                	<i class="fa fa-eye"></i> 查看　</a>　
                	<a id="del" href="javascript:;" onClick="delComment(<?php echo $m['messageId']; ?>)">
	                	<i class="fa fa-trash-o"></i> 删除　</a>
                </td>
              </tr>
             <?php endforeach; endif; else: echo "" ;endif; ?>
              <tr  height="80px"><td colspan="6"><div class="pagelist"><?php echo $message->render(); ?></div></td></tr>
            </tbody>
          </table>
        </div>
