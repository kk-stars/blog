<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:62:"D:\B\AppServ\www\blog/application/index\view\article\arts.html";i:1523872876;s:60:"D:\B\AppServ\www\blog/application/index\view\public\nav.html";i:1523844774;s:61:"D:\B\AppServ\www\blog/application/index\view\Public\info.html";i:1523841030;s:64:"D:\B\AppServ\www\blog/application/index\view\Public\backtop.html";i:1522998704;s:63:"D:\B\AppServ\www\blog/application/index\view\Public\footer.html";i:1523453490;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="utf-8">
...
<body id="blog">
<div style="    border-radius: 0 0 20px 20px;position: fixed; left: 0; top: 0; z-index: 999; right: 0; box-shadow: 0 3px 15px -3px #ccc; background: rgba(255, 255, 255, 0.74);">
...
<nav class="am-g am-g-fixed blog-fixed blog-nav" style="width:930px;">
	<div class="navbar-header" style="position: absolute; margin-left: -278px; margin-top: 5px;">
		<a href="home"><img alt="" src="__PUBLIC__index/images/lg.png" style="width: 278px;" title="BABYSBREATH" /></a>
  	</div>
...
<!-- content srart -->
<div class="am-g am-g-fixed blog-fixed" style="margin-top:120px;padding-top: 20px;padding-left: 1.5rem; padding-right: 1.5rem;">
    <div class="am-u-md-12 am-u-sm-12">

		<?php if(is_array($arts) || $arts instanceof \think\Collection || $arts instanceof \think\Paginator): $i = 0; $__LIST__ = $arts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?>
	        <article class="am-g blog-entry-article" id='my-art' style=" margin-top:0;">
	            ...
	            <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img" style="width:340px;">
	                ...
	                <?php else: ?>
		                <a href="article?aid=<?php echo $ca['articleId']; ?>" >
		                	<img src="__PUBLIC__<?php echo $ca['articlePic']; ?>" style="cursor:pointer;padding-top:1rem;" alt="" title="<?php echo $ca['articleTitle']; ?>" class="am-u-sm-12">
		                </a>
	                <?php endif; ?>
	                <p id='p-bottom'>
	                	<span id='cateName'>
	                		<i class='am-icon-navicon' style="color:#10D07A;"></i> <?php echo $ca['cateName']; ?>
	                	</span> &nbsp;&nbsp;
						...
						<?php if($ca['praiseClicks'] != null): ?>
              			<span><i class='am-icon-heart' style="color:#ef6464;"> </i>&nbsp;<?php echo $ca['praiseClicks']; ?> </span> &nbsp;&nbsp;
              			<?php else: ?>
		...
		<div style="    margin-bottom: 15px;"><?php echo $arts -> render(); ?></div>
    </div>
	        ...
	        <div class="blog-clear-margin blog-sidebar-widget blog-bor am-g ">
	            ...
	            <div class="am-u-sm-12 blog-clear-padding">
					<?php if(is_array($tags) || $tags instanceof \think\Collection || $tags instanceof \think\Paginator): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
	            		<a href="artlist?t=<?php echo $t; ?>" class="blog-tag">
