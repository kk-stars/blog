<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:63:"D:\B\AppServ\www\blog/application/admin\view\auth_rule\lst.html";i:1523430804;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\header.html";i:1524129480;s:62:"D:\B\AppServ\www\blog/application/admin\view\Public\aside.html";i:1524014121;s:68:"D:\B\AppServ\www\blog/application/admin\view\Public\loginRecord.html";i:1524130899;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\wechat.html";i:1524130402;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\prompt.html";i:1517304229;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <h1 class="page-header">操作</h1>
        ...
        <h1 class="page-header">管理权限 <span class="badge"><?php echo $arcount; ?></span></h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
             <?php if(is_array($AuthRule) || $AuthRule instanceof \think\Collection || $AuthRule instanceof \think\Paginator): $i = 0; $__LIST__ = $AuthRule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ar): $mod = ($i % 2 );++$i;?>
              <tr id="id_<?php echo $ar['id']; ?>">
                <td><?php echo $ar['id']; ?></td>
                <td><?php if($ar['pid'] != 0): ?>|<?php endif; ?><?php echo str_repeat("——",$ar['level']) ?><?php echo $ar['name']; ?></td>
                <td><?php echo $ar['title']; ?></td>
                <td><?php echo $ar['level'] + 1; ?>级</td>
                <td><a rel="1" onclick="updRule(<?php echo $ar['id']; ?>)" data-toggle="modal" data-target="#upAdmin">修改</a>　
                    <a rel="1" onclick="delRule(<?php echo $ar['id']; ?>)">删除</a>
                </td>
              </tr>
