<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"G:\PHPWAMP_IN2\wwwroot\blog\thinkphp\tpl\dispatch_jump.tpl";i:1519809680;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <title>提示信息</title>
...
<div class="error-container">
    <div class="errorcon">
		<?php switch ($code) {case 1:?>
		    <h1>后台管理系统-信息提示</h1>
		    <i class="icon-smile-o"></i><?php echo(strip_tags($msg));break;case 0:?>
		    <h1>后台管理系统-信息提示</h1>
		    <i class="icon-frown-o"></i><?php echo(strip_tags($msg));break;} ?>
    </div>
