<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:64:"D:\B\AppServ\www\blog/application/admin\view\admin\adminlog.html";i:1524134060;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\header.html";i:1524129480;s:62:"D:\B\AppServ\www\blog/application/admin\view\Public\aside.html";i:1524014121;s:61:"D:\B\AppServ\www\blog/application/admin\view\Public\info.html";i:1521016881;s:68:"D:\B\AppServ\www\blog/application/admin\view\Public\loginRecord.html";i:1524130899;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\wechat.html";i:1524130402;s:63:"D:\B\AppServ\www\blog/application/admin\view\Public\prompt.html";i:1517304229;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="" method="post">
        <h1 class="page-header">管理 <span class="badge"><?php echo $aLogCount; ?></span></h1>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th width="200px"><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">管理员</span></th>
            ...
            <tbody>
             <?php if(is_array($aLog) || $aLog instanceof \think\Collection || $aLog instanceof \think\Paginator): $i = 0; $__LIST__ = $aLog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$al): $mod = ($i % 2 );++$i;?>
              <tr id="lid_<?php echo $al['id']; ?>">
                <td><input type="checkbox" class="input-control" id="commentid" name="checkbox[]" value="<?php echo $al['id']; ?>" /><?php echo $al['id']; ?></td>
                <td class="article-title"><?php echo $al['operation']; ?></td>
                <td class="article-title"><?php if($al['operationStatus'] == 1): ?>成功<?php else: ?>失败<?php endif; ?></td>
                <td class="article-title"><?php echo $al['IP']; ?></td>
                <td class="article-title"><?php echo $al['adminName']; ?></td>
                <td class="article-title"><?php echo $al['addTime']; ?></td>
                <td><a id="seeComment" href="javascript:;" onClick="seeComment(<?php echo $al['id']; ?>)">查看</a>　
                	<a id="del" href="javascript:;" onClick="delComment(<?php echo $al['id']; ?>)">删除</a>
                </td>
              </tr>
             <?php endforeach; endif; else: echo "" ;endif; ?>
              <tr  height="80px"><td colspan="7"><div class="pagelist"><?php echo $aLog->render(); ?></div></td></tr>
            </tbody>
          </table>
        </div>
      </form>
...
function seeComment(id) {
		...
		$.post('__URL__/logInfo',{'id':id},function(data){
			...
			if(d.code == 1){
				...
				$('#admin').html(d.message.adminName);
