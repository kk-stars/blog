<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\B\AppServ\www\blog/application/index\view\mood\mood.html";i:1523876845;s:60:"D:\B\AppServ\www\blog/application/index\view\public\nav.html";i:1523937922;}*/ ?>
<!doctype html>
<html lang="zh">
<head>
	<meta charset="UTF-8">
	...
	<title><?php echo $conf['title']; ?> - 心情随笔</title>
...
<div class="jq22-container mood-div">
	<div class="cntl">
			...
			<?php if(is_array($mood) || $mood instanceof \think\Collection || $mood instanceof \think\Paginator): $i = 0; $__LIST__ = $mood;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$m): $mod = ($i % 2 );++$i;?>
				<div class="cntl-state">
					<div class="cntl-content">
						...
						<p><?php echo $m['moodContent']; ?></p>
						<p class='mood-addtime'><?php echo $m['addTime']; ?></p>
					</div>
					<?php if($m['moodPic'] != null): ?>
						<div class="cntl-image"><img src="__PUBLIC__<?php echo $m['moodPic']; ?>" class="mood-img"></div>
					<?php endif; ?>
					<div class="cntl-icon cntl-center"><?php echo $m['day']; ?></div>
				</div>
