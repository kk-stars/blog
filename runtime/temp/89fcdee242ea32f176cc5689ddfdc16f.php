<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"D:\B\AppServ\www\blog/application/index\view\article\noslider.html";i:1523425908;s:60:"D:\B\AppServ\www\blog/application/index\view\public\nav.html";i:1523518949;s:61:"D:\B\AppServ\www\blog/application/index\view\Public\info.html";i:1523446361;s:64:"D:\B\AppServ\www\blog/application/index\view\Public\backtop.html";i:1522998704;s:63:"D:\B\AppServ\www\blog/application/index\view\Public\footer.html";i:1523453490;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="am-collapse am-topbar-collapse" id="blog-collapse" style="width: 80%;margin: 10px auto;">
    ...
    $(function(){
	    ...
	    $("#active li").click(function() {
	        ...
	        $(this).siblings('li').removeClass('am-active');  // 删除其他兄弟元素的样式

	        $(this).addClass('am-active');                            // 添加当前元素的样式
...
<div class="am-g am-g-fixed blog-fixed" style="margin-top:120px;*background:#fff;padding-top: 20px;padding-left: 1.5rem;
    ...
    <div class="am-u-md-12 am-u-sm-12">
		<div style="width:105%;height:30px;background:;border-radius:10px;border-bottom:2px solid #86d1ef;font-size:14px;margin-left: -18px;">　文章分类 >> <?php echo $cateName; ?><a style="float:right;" href="<?php echo url('index/index'); ?>">返回首页>>　</a></div>
		<?php if(is_array($cArticle) || $cArticle instanceof \think\Collection || $cArticle instanceof \think\Paginator): $i = 0; $__LIST__ = $cArticle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?>
		...
		<div><?php echo $cArticle -> render(); ?></div>
    </div>
